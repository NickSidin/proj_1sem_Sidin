...
import info_store
import info_items
import info_store_requests
import info_stock
import info_composition

with sq.connect("praktos.db") as con:
...
with sq.connect("praktos.db") as con: con.execute("""CREATE TABLE IF NOT EXISTS store_requests(
...
with sq.connect("praktos.db") as con: con.execute("""CREATE TABLE IF NOT EXISTS composition( 
comp_id INTEGER PRIMARY KEY, 
req_id INTEGER, 
it_id INTEGER, 
quantity INTEGER, 
FOREIGN KEY (req_id) REFERENCES store_requests(req_id), 
FOREIGN KEY (it_id) REFERENCES items(it_id)
